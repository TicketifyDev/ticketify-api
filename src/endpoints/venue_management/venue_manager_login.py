...
from src.common.constants import VENUE_MANAGER_LOGIN_COLLECTION
...
storeCollection = MongoDB(VENUE_MANAGER_LOGIN_COLLECTION)
async def venueManager_login(details : AuthModel, collection, request : Request):
    """ 
    ...
    return JSONResponse(
        content=response_content(
            ...
            data={
                ...
                "token_type": "bearer",
                "access_token_expires_in": 1800,  # Access token expiry time 
